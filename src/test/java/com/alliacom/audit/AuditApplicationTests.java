...
public class AuditApplicationTests {
	...
	public void readExcelFileTest() {
		...
		try {
			Map<String, Object> result = rapport.read();
	...
	@Test
	public void getAnalysesByEmail() {
		List<Analyse> list = analyseRepository.analysesByEmail("ftitiaymen99@gmail.com");
		for (Analyse analyse : list) {
			System.out.println(analyse.getRapport());
		}
	}
